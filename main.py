...
sourceRadioButton1 = ttk.Radiobutton(frame,text =
"Delhi",value=0,variable=var1)
sourceRadioButton1.grid(column=1, row=3, sticky=(W, E))
sourceRadioButton2 = ttk.Radiobutton(frame,text =
"Mumbai",value=1,variable=var1)
...
destinationRadioButton1 = ttk.Radiobutton(frame,text =
"Chennai",value=0,variable=var2)
destinationRadioButton1.grid(column=1, row=4, sticky=(W, E))
destinationRadioButton2 = ttk.Radiobutton(frame,text =
"Kolkata",value=1,variable=var2)
